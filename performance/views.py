        ...
        try:
            ...
            if chunk_index == 0 and not is_transcript_override:
                with pdfplumber.open(pdf_io) as peek_pdf:
                    if peek_pdf.pages:
                        first_page_text = peek_pdf.pages[0].extract_text() or ""
...
class ToggleTranscriptFLRView(View):
    ...
    def post(self, request, student_number, *args, **kwargs):
        ...
        return redirect(reverse("transcript_student_detail", kwargs={"student_number": student_number}) + "?from=transcript")
...
class TranscriptGridView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Read existing session data before the loop
            ...
            for student in students:
                ...
                student_dict["detail_url"] = (
                    f"/performance/transcript/{student.student_number}/?from=transcript"
                )
